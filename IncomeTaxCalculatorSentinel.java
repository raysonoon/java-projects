...
/* Java program that calculates income tax payable (in double) until user enters -1 */
    ...
    public static void main(String[] args) {
        ...
        while (taxableIncome != SENTINEL) {
            ...
            if (taxableIncome <= 20000) {
                ...
                incomeTax = 20000 * TAX_RATE_AFTER_20K + 20000 * TAX_RATE_AFTER_40K
                        + (taxableIncome - 60000) * TAX_RATE_AFTER_60K;
            }
            // Print income tax
